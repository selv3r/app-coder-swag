...
class DataService {
    ...
    private let shirts = [
        ...
        Product(title: "Devslopes Logo Shirt Light Grey", price: "$30", imageName: "shirt02.png"),
        Product(title: "Devslopes Logo Shirt Red", price: "$30", imageName: "shirt03.png"),
        Product(title: "Hustle Delegate Grey", price: "$30", imageName: "shirt04.png"),
        Product(title: "Kickflip Studios Black", price: "$30", imageName: "shirt05.png")
    ]
